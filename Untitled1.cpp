...
class cargo {	 
    ...
    public:   	
    	cargo(string id = "", double w = 0.0, string dim = "", string dest = "", string type ="") :
		cargoID(id), weight(w), dimensions(dim), destination(dest) {}
    void setCargoInfo() {
        cout << "Enter Cargo ID: ";
        cin >> cargoID;
    ...
    void displayCargoInfo() {
        ...
        cout << "Dimensions: " << dimensions << " (LxWxH)" << endl;
			...
			case 54:
			    {
                	...
                	cargoObj.setCargoInfo();
                	cout << "Cargo Information:" << endl;
                	cargoObj.displayCargoInfo();
                	break;
